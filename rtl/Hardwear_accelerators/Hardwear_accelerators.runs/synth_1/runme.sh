...
HD_PWD='C:/Users/tagda/OneDrive/Desktop/GIT_HUB/EVAULT-R/event-vault-R/rtl/Hardwear_accelerators/Hardwear_accelerators.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log evaultr_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source evaultr_top.tcl
